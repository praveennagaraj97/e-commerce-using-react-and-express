...
ordersRouter.route("/updateDeliveryStatus/:id").patch(_orderController.protectRoute, (0, _orderController.restrictTo)("manufacturer"), _orderController.updateOrderStatus);