...
productRouter.route("/dev/updateProduct/:id").patch(_productsController.protectRoute, (0, _productsController.restrictTo)("manufacturer"), _productsController.updateProduct);