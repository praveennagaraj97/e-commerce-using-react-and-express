...
export const signUp = async (parent, args, { User }, info) => {
...
export const signIn = async (parent, args, { User }, info) => {
  ...
  if (!validPassword) return new ApolloError("Entered password is wrong", 401);
