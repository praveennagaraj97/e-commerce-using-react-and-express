...
export const ProductPetReview = ({ productReviewDetail: { productId } }) => {
  ...
  const [howHappyIsYourPet, setHowHappyisYourPet] = useState(5);
  ...
  const reviewFields = [
    {
      title: "How happy is your furry friend 😍",
      value: howHappyIsYourPet,
      setter: setHowHappyisYourPet,
      eleName: "howHappyIsYourPet",
    },
